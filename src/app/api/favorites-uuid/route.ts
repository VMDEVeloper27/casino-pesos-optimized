...
// GET /api/favorites-uuid - Get user's favorites
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error in GET /api/favorites-uuid:', error);
    return NextResponse.json({ favorites: [] });
  }
}

// POST /api/favorites-uuid - Add to favorites
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in POST /api/favorites-uuid:', error);
    return NextResponse.json(
...
// DELETE /api/favorites-uuid - Remove from favorites
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error('Error in DELETE /api/favorites-uuid:', error);
    return NextResponse.json(
      { error: 'Internal server error' },
      { status: 500 }
    );
